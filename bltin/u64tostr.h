...
void ba_BltinU64ToStr(struct ba_Controller* ctr) {
	...
	ba_AddIM(&ctr->im, 2, BA_IM_PUSH, BA_IM_RBP);
	ba_AddIM(&ctr->im, 2, BA_IM_PUSH, BA_IM_R8);
	ba_AddIM(&ctr->im, 2, BA_IM_PUSH, BA_IM_R9);
	ba_AddIM(&ctr->im, 2, BA_IM_PUSH, BA_IM_R10);
	...
	ba_AddIM(&ctr->im, 3, BA_IM_PUSH, BA_IM_IMM, 0);
	ba_AddIM(&ctr->im, 3, BA_IM_PUSH, BA_IM_IMM, 0x30);
	ba_AddIM(&ctr->im, 2, BA_IM_INC, BA_IM_R9);
	ba_AddIM(&ctr->im, 2, BA_IM_LABELJMP, ctr->labelCnt-1);
	...
	ba_AddIM(&ctr->im, 4, BA_IM_MOV, BA_IM_R10, BA_IM_IMM, 0x30);
	...
	ba_AddIM(&ctr->im, 5, BA_IM_ADD, BA_IM_ADRSUB, BA_IM_RBP, 0x18, BA_IM_RAX);
	...
	ba_AddIM(&ctr->im, 5, BA_IM_ADD, BA_IM_ADRSUB, BA_IM_RBP, 0x10, BA_IM_RSI);
	ba_AddIM(&ctr->im, 4, BA_IM_SUB, BA_IM_RDX, BA_IM_IMM, 0x08);
	ba_AddIM(&ctr->im, 4, BA_IM_MOV, BA_IM_RSI, BA_IM_ADR, BA_IM_RDX);
	ba_AddIM(&ctr->im, 3, BA_IM_MOV, BA_IM_RAX, BA_IM_RSI);
	ba_AddIM(&ctr->im, 3, BA_IM_ROR, BA_IM_RAX, BA_IM_CL);
	ba_AddIM(&ctr->im, 3, BA_IM_AND, BA_IM_RAX, BA_IM_RDI);
	ba_AddIM(&ctr->im, 5, BA_IM_ADD, BA_IM_ADRSUB, BA_IM_RBP, 0x10, BA_IM_RAX);
	ba_AddIM(&ctr->im, 3, BA_IM_ROR, BA_IM_RSI, BA_IM_CL);
	ba_AddIM(&ctr->im, 3, BA_IM_AND, BA_IM_RSI, BA_IM_R8);
	ba_AddIM(&ctr->im, 5, BA_IM_ADD, BA_IM_ADRSUB, BA_IM_RBP, 0x08, BA_IM_RSI);
	...
	ba_AddIM(&ctr->im, 4, BA_IM_MOV, BA_IM_R10, BA_IM_ADR, BA_IM_RBP);
	ba_AddIM(&ctr->im, 5, BA_IM_MOV, BA_IM_R9, BA_IM_ADRADD, BA_IM_RBP, 0x08);
	ba_AddIM(&ctr->im, 5, BA_IM_MOV, BA_IM_R8, BA_IM_ADRADD, BA_IM_RBP, 0x10);
	ba_AddIM(&ctr->im, 5, BA_IM_MOV, BA_IM_RBP, BA_IM_ADRADD, BA_IM_RBP, 0x18);
