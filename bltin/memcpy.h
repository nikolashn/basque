...
#ifndef BA__BLTIN_MemCpy_H
#define BA__BLTIN_MemCpy_H

#include "bltinflags.h"

/* Params (rax): dest ptr; (stack): src ptr (0x8), mem size (0x8)
 * Returns (rax): dest ptr */
void ba_BltinMemCpy(struct ba_Controller* ctr) {
	ba_BltinFlagsSet(BA_BLTIN_MemCpy);
	ba_BltinLabels[BA_BLTIN_MemCpy] = ctr->labelCnt;
	ctr->labelCnt += ???;
	...
	// TODO: replace all this code with actual MemCpy code
